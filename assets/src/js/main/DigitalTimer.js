export default class DigitalTimer {
    ...
    constructor(time, statusObject, callback = null) {
    ...
    start() {
        ...
        if (!this.isRun && !this.isEnd) {
            ...
            this.interval = setInterval(function () {
                ...
                self.statusObject.setCount(`${self.ids.minutes.active}${self.ids.minute.active}:${self.ids.seconds.active}${self.ids.second.active}`);
                self.play('second');
                self.seconds++;
